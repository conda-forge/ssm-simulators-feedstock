...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ssm-simulators-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ssm-simulators-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add ssm-simulators
# for installing globally
pixi global install ssm-simulators
```
...
It is possible to list all of the versions of `ssm-simulators` available on your platform:
...
```
pixi search ssm-simulators --channel conda-forge
```
